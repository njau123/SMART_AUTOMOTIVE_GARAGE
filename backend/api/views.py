...
class DiagnosisChatView(APIView):
    """Chat-style AI diagnosis — multi-turn with persistence."""
    permission_classes = [AllowAny]
    parser_classes = [MultiPartParser, FormParser, JSONParser]

    def post(self, request):
        from apps.ai_diagnosis.services.groq_service import chat_with_ai
        from apps.ai_diagnosis.models import ChatConversation, ChatMessageLog
        import json
        ...
        if conversation_id:
            try:
                ...
                if user and conv.user_id and conv.user_id != user.id:
                    conv = None  # Usiruhusu user mwingine
